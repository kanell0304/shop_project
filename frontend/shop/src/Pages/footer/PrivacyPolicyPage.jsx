    ...
    <BasicLayout>
      ...
      <div>
        <ul>
          <li>(주)○○○ 개인정보처리방침</li>
          <li>
            (주)○○○은 (이하 "회사"는) 「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.
          </li>
          <li>개인정보처리방침은 다음과 같은 내용을 담고 있습니다.
            <ol>
              <li>개인정보의 처리 목적</li>
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                (2) 재화 또는 서비스 제공
                <p>콘텐츠 제공, 구매 및 요금 결제, 물품배송 또는 청구서 등 발송, 서비스 제공, 맞춤서비스 제공을 목적으로 개인정보를 처리합니다.</p>
              </li>
              <li>
                (3) 마케팅 및 광고에의 활용
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                <ol>
                  <li>① 홈페이지 회원가입 및 관리 : 회원탈퇴 시까지</li>
                  <li>② 재화 또는 서비스 제공 : 재화·서비스 공급완료 및 요금결제·정산 시까지</li>
                </ol>
              </li>
              <li>
          ...
          <li>
            <strong>3. 처리하는 개인정보의 항목 및 수집 방법</strong>
            <ul>
              <li>
                (1) 처리하는 개인정보 항목
                <ol>
                  <li>① 회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
                    <ul>
                      <li>- 일반 회원가입 시
                        <ul>
                          <li>필수항목 : 아이디, 비밀번호, 이름 , 이메일, 휴대전화, 생년월일, (만 14세 미만 가입자인 경우) 법정대리인 정보</li>
                          <li>선택항목 : 성별</li>
                        </ul>
                      </li>
                      <li>- 상품 주문 시
                        <ul>
                          <li>필수항목 : 주문 정보(이름, 이메일, 휴대전화), 배송 정보(이름, 주소, 휴대전화), (비회원 주문인 경우) 주문 조회 비밀번호</li>
                          <li>선택항목 : 일반전화</li>
                        </ul>
                      </li>
                      <li>- 카카오 간편 로그인 시
                  ...
                  <li>② 서비스 이용과정이나 사업 처리과정에서 아래와 같은 정보들이 생성되어 수집될 수 있습니다.
                    <ul>
                      <li>- 서비스 이용기록, 접속로그, 쿠키, 접속IP 정보, 결제기록, 이용정지기록, 불량이용기록</li>
                    </ul>
                  </li>
                </ol>
              </li>
              <li>
                (2) 수집 방법
                <ul>
                  <li>- 홈페이지, 서면양식, 게시판, 이메일, 이벤트 응모, 배송요청, 전화, 팩스, 제휴사로부터의 제공, 생성정보 수집 툴을 통한 수집</li>
                </ul>
              </li>
            </ul>
          </li>
          <li>
            <strong>4. 만 14세 미만 아동의 개인정보 처리에 관한 사항</strong>
            <ul>
              <li>
                (1) 회사는 만 14세 미만 아동에 대해 개인정보를 수집할 때 법정대리인의 동의를 얻어 해당 서비스 수행에 필요한 최소한의 개인정보를 수집합니다.
                <ul>
                  <li>- 필수항목 : [법정대리인 동의 양식을 통해 수집하는 개인정보 기재]</li>
                </ul>
              </li>
              <li>
          ...
          <li>
            <strong>5. 개인정보의 제3자 제공에 관한 사항</strong>
            <ul>
              <li>(1) 회사는 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.</li>
              ...
              <li>(3) 회사는 정부 관계부처가 합동으로 발표한 「긴급상황 시 개인정보 처리 및 보호수칙」에 따라 재난, 감염병, 급박한 생명·신체 위험을 초래하는 사건·사고, 급박한 재산 손실 등의 긴급상황이 발생하는 경우 정보주체의 동의 없이 관계기관에 개인정보를 제공할 수 있습니다.
                <a href="여기">자세한 사항은 여기*를 눌러 확인하시기 바랍니다.</a>
              </li>
            </ul>
          </li>
          <li>
            <strong>6. 개인정보처리의 위탁에 관한 사항</strong>
            <ul>
              <li>(1) 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
                <table>
                  <thead>
                    <tr>
                      <th>수탁업체</th>
                  ...
                  <tbody>
                    <tr>
                      <td>카페24(주)</td>
                      <td>쇼핑몰 호스팅 서비스의 시스템 제공 및 유지∙보수</td>
                    </tr>
                    <tr>
                      <td>[택배사 이름]</td>
                      <td>[택배사 위탁 내용]</td>
          ...
          <li>
            <strong>7. 개인정보의 파기절차 및 파기방법</strong>
            ...
            <ul>
              <li>(1) 파기 절차
                <ol>
                  ...
                  <li>② 별도 DB로 옮겨진 개인정보는 법률에 의한 경우를 제외하고 다른 목적으로 이용되지 않습니다.</li>
                </ol>
              </li>
              <li>(2) 파기방법
                <ol>
          ...
          <li>
            <strong>8. 정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항</strong>
            <ul>
              <li>(1) 정보주체는 회사에 대해 언제든지 개인정보 열람·정정·삭제·처리정지 요구 등의 권리를 행사할 수 있습니다.</li>
              <li>(2) 정보주체의 개인정보 조회,수정을 위해서는 "개인정보변경"(또는 "회원정보수정" 등)을 가입해지(동의철회)를 위해서는 "회원탈퇴"를 클릭하여 본인 확인 절차를 거치신 후 직접 열람, 정정 또는 탈퇴가 가능합니다.</li>
              <li>(3) 혹은 개인정보보호책임자에게 서면, 전화 또는 이메일로 연락하시면 지체없이 조치하겠습니다.</li>
              <li>(4) 제1항에 따른 권리 행사는 정보주체의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있으며, 이 경우 “개인정보 처리 방법에 관한 고시(제2020-7호)” 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.</li>
              <li>(5) 개인정보 열람 및 처리정지 요구는 「개인정보 보호법」 제35조 제4항, 제37조 제2항에 의하여 정보주체의 권리가 제한될 수 있으며, 개인정보의 정정 및 삭제 요구는 다른 법령에서 그 개인정보가 수집 대상으로 명시되어 있는 경우에는 그 삭제를 요구할 수 없습니다.</li>
          ...
          <li>
            <strong>10. 개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에 관한 사항</strong>
            <p>회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 ‘쿠키(cookie)’를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버가 이용자의 컴퓨터 브라우저에게 보내는 소량의 정보이며 이용자들의 PC 컴퓨터내의 하드디스크에 저장되기도 합니다.</p>
            <ul>
              <li>(1) 쿠키 사용 목적
                <p>이용자가 방문한 각 서비스와 웹 사이트들에 대한 방문 및 이용형태, 인기 검색어, 보안접속 여부, 등을 파악하여 이용자에게 최적화된 정보 제공을 위해 사용됩니다.</p>
              </li>
              <li>(2) 쿠키의 설치•운영 및 거부
                <p>웹브라우저 상단의 도구&gt 인터넷 옵션&gt 개인정보 메뉴의 옵션 설정을 통해 쿠키 저장을 거부 할 수 있습니다.<br />
          ...
          <li>
            ...
            <ul>
              <li>(1) 회사는 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
                <ul>
                  <li>o 개인정보 보호책임자 성명 : OOO</li>
                  <li>o 소속 : OOO</li>
                  <li>o 전화번호 : OO-OOO-OOOO</li>
                  <li>o 이메일 :</li>
                  <li>o 개인정보 보호담당자 성명 : OOO</li>
                  <li>o 소속 : OOO</li>
                  <li>o 전화번호 : OO-OOO-OOOO</li>
                  <li>o 이메일 :</li>
                </ul>
              </li>
              <li>(2) 정보주체는 회사의 서비스를 이용하시면서 발생한 모든 개인정보보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당자에게 문의할 수 있습니다. 회사는 정보주체의 문의에 대해 지체없이 답변 및 처리해드릴 것입니다.</li>
            </ul>
          </li>
          <li>
            <strong>12. 정보주체의 권익침해에 대한 구제방법</strong>
            <ul>
              <li>(1) 개인정보침해로 인한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.
                <ul>
              ...
              <li>(2) 「개인정보 보호법」제35조(개인정보의 열람), 제36조(개인정보의 정정·삭제), 제37조(개인정보의 처리정지 등)의 규정에 의한 요구에 대하여 공공기관의 장이 행한 처분 또는 부작위로 인하여 권리 또는 이익의 침해를 받은 자는 행정심판법이 정하는 바에 따라 행정심판을 청구할 수 있습니다.
                <p>※ 행정심판에 대해 자세한 사항은 중앙행정심판위원회(www.simpan.go.kr) 홈페이지를 참고하시기 바랍니다.</p>
              </li>
            </ul>
          </li>
          <li>
            <strong>13. 개인정보처리방침 변경</strong>
            <p>이 개인정보처리방침은 OOOO년 OO월 OO일부터 적용됩니다.</p>
          </li>
        </ul>
      </div>
    </BasicLayout>
